                                    ...
                                    <tr style={{ backgroundColor: '#F9FAFB' }}>
                                        ...
                                        {!isClient ? (
                                            ...
                                            <>
                                                ...
                                                <th style={{ textAlign: 'center', padding: '6px 2px', color: '#EC4899', fontWeight: 600, borderBottom: '1px solid #E5E7EB' }}>RSSI</th>
                                            </>
                                        )}
                                    </tr>
                                </thead>
                                        ...
                                        <tr key={i} style={{ backgroundColor: i % 2 === 0 ? '#FFFFFF' : '#F9FAFB' }}>
                                            ...
                                            {!isClient ? (
                                                ...
                                                <>
                                                    ...
                                                    <td style={{ padding: '4px 2px', textAlign: 'center', borderBottom: '1px solid #F3F4F6', color: '#DB2777', fontWeight: 700 }}>
                                                        {s.rssi || "-"}
                                                    </td>
                                                </>
                                            )}
